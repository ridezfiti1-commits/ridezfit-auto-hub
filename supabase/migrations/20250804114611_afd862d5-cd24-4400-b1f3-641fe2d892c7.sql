-- Temporarily disable foreign key constraint for admin_id to insert sample data
ALTER TABLE public.cars DROP CONSTRAINT IF EXISTS cars_admin_id_fkey;
ALTER TABLE public.merchandise DROP CONSTRAINT IF EXISTS merchandise_admin_id_fkey;
ALTER TABLE public.services DROP CONSTRAINT IF EXISTS services_admin_id_fkey;

-- Insert sample cars without FK constraint
